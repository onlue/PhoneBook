...
{
	ShowMessage("Телефонный справочник, предназначен для удобного хранения номеров и некоторой другой информации");
}
//---------------------------------------------------------------------------
...
void __fastcall TForm2::НапоминалкаClick(TObject *Sender)
{
